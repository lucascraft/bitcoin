 ...
 * @generated
 */
public class BitcoindAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected BitcoindSwitch<Adapter> modelSwitch =
		new BitcoindSwitch<Adapter>() {
			@Override
			public Adapter caseBitcoinCmd(BitcoinCmd object) {
				return createBitcoinCmdAdapter();
			}
			@Override
			public Adapter caseGetInfoCmd(GetInfoCmd object) {
				return createGetInfoCmdAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.btc.node.bitcoind.BitcoinCmd <em>Bitcoin Cmd</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBitcoinCmdAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.btc.node.bitcoind.GetInfoCmd <em>Get Info Cmd</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGetInfoCmdAdapter() {
		return null;
	}
