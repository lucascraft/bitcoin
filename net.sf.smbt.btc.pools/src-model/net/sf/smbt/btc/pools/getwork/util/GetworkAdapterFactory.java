/**
 */
package net.sf.smbt.btc.pools.getwork.util;
 ...
 * @generated
 */
public class GetworkAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static GetworkPackage modelPackage;
	 ...
	 * @generated
	 */
	public GetworkAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = GetworkPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected GetworkSwitch<Adapter> modelSwitch =
		new GetworkSwitch<Adapter>() {
			@Override
			public Adapter caseGetworkCmd(GetworkCmd object) {
				return createGetworkCmdAdapter();
			}
			@Override
			public Adapter caseWorkStateTmp(WorkStateTmp object) {
				return createWorkStateTmpAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.btc.pools.getwork.GetworkCmd <em>Cmd</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGetworkCmdAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.btc.pools.getwork.WorkStateTmp <em>Work State Tmp</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createWorkStateTmpAdapter() {
		return null;
	}
