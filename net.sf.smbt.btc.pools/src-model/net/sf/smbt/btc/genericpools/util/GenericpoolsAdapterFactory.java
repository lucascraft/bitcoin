 ...
 * @generated
 */
public class GenericpoolsAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public GenericpoolsAdapterFactory() {
	 ...
	 * @generated
	 */
	protected GenericpoolsSwitch<Adapter> modelSwitch =
		new GenericpoolsSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter casePoolsManager(PoolsManager object) {
				return createPoolsManagerAdapter();
			}
			@Override
			public Adapter caseAsicBatchWork(AsicBatchWork object) {
				return createAsicBatchWorkAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.btc.genericpools.Setting <em>Setting</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.btc.genericpools.PoolsManager <em>Pools Manager</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPoolsManagerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.btc.genericpools.AsicBatchWork <em>Asic Batch Work</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAsicBatchWorkAdapter() {
		return null;
	}
