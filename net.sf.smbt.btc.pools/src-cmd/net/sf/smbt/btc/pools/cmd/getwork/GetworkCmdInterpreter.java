...
package net.sf.smbt.btc.pools.cmd.getwork;
...
public class GetworkCmdInterpreter  extends AbstractCmdInterpreterImpl {
	@Override
	public synchronized byte[] cmd2ByteArray(final Cmd cmd) {
		if (cmd instanceof GetworkCmd) {
			return GetWorkProtocolUtils.INSTANCE.dump((GetworkCmd)cmd);
		}
		return new byte[0];
	}
}