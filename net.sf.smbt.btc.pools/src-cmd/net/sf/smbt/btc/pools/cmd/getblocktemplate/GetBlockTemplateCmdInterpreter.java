...
package net.sf.smbt.btc.pools.cmd.getblocktemplate;
...
public class GetBlockTemplateCmdInterpreter  extends AbstractCmdInterpreterImpl {
	@Override
	public synchronized byte[] cmd2ByteArray(final Cmd cmd) {
		if (cmd instanceof GetBlockTemplateCmd) {
			return null;
		}
		return new byte[0];
	}
