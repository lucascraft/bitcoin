...
package net.sf.smbt.btc.pools.bitminter.cmd;
...
public class BitMinterFrameInterpreter  extends AbstractFrameInterpreterImpl {
	@Override
	public synchronized Cmd byteArray2Cmd(final byte[] frame) {
		Cmd atCmd = BitMinterCmdUtils.INSTANCE.handlePachubeFrame(frame);
		return atCmd;
	}
}
