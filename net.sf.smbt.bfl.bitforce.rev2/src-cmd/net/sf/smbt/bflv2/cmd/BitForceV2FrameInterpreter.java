...
public class BitForceV2FrameInterpreter  extends AbstractFrameInterpreterImpl {
	@Override
	public synchronized Cmd byteArray2Cmd(final byte[] stream) {
		BFLCmd atCmd = Bitforcev2Factory.eINSTANCE.createBFLCmd();
		if (stream != null) {
			String text = new String(stream);
			System.out.println("info input : " + text);
