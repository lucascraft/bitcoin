...
public class TradeBotsConfigWizardPage extends WizardPage {
	
	private Label locationLabel;
	private Button asAWorkspaceFileChoiceButton;

	protected TradeBotsConfigWizardPage() {
		super("Trade Bots Configuration");
	}
	...
	public void createControl(Composite parent) {
		...
		locationLabel.setText("Create trade bots config");
