...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.btc.pools.bitminter.Chain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChainItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chain_accepted_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chain_accepted_feature", "_UI_Chain_type"),
				 BitminterPackage.Literals.CHAIN__ACCEPTED,
				 true,
				 false,
				 false,
	...
	protected void addRejectedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chain_rejected_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chain_rejected_feature", "_UI_Chain_type"),
				 BitminterPackage.Literals.CHAIN__REJECTED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chain_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chain_duration_feature", "_UI_Chain_type"),
				 BitminterPackage.Literals.CHAIN__DURATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addDifficultyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chain_difficulty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chain_difficulty_feature", "_UI_Chain_type"),
				 BitminterPackage.Literals.CHAIN__DIFFICULTY,
				 true,
				 false,
				 false,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Chain_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Chain_id_feature", "_UI_Chain_type"),
				 BitminterPackage.Literals.CHAIN__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Chain)object).getId();
