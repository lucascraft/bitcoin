...
public abstract class AbstractBtcPoolsOutlinePage extends Page implements IContentOutlinePage, ISelectionChangedListener, IAdaptable {
	...
	private AbstractBtcPoolsModelNavigator navigator;
...
//	private CollapseAllHandler collapseAllHandler;
	...
	private BitMinterPoolsEditor editor;
	 ...
	 */
	public AbstractBtcPoolsOutlinePage(BitMinterPoolsEditor ed) {
...
//	}
	 ...
	 * @return the editor
	 */
	protected BitMinterPoolsEditor getEditor() {
		return editor;
	}
	 ...
	 */
	protected abstract AbstractBtcPoolsModelNavigator createNavigator(Composite parent, IPageSite pageSite);
