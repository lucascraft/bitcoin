 ...
 * <ul>
 *   <li>{@link net.sf.smbt.btc.pools.getwork.impl.GetworkCmdImpl#getJsonSnd <em>Json Snd</em>}</li>
 *   <li>{@link net.sf.smbt.btc.pools.getwork.impl.GetworkCmdImpl#getJsonRcv <em>Json Rcv</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GetworkCmdImpl extends HttpCommCmdImpl implements GetworkCmd {
	/**
	...
	protected EClass eStaticClass() {
		return GetworkPackage.Literals.GETWORK_CMD;
	}
	...
	public void setJsonSnd(String newJsonSnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GetworkPackage.GETWORK_CMD__JSON_SND, oldJsonSnd, jsonSnd));
	}
	...
	public void setJsonRcv(String newJsonRcv) {
		...
		jsonRcv = newJsonRcv;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GetworkPackage.GETWORK_CMD__JSON_RCV, oldJsonRcv, jsonRcv));
	}
