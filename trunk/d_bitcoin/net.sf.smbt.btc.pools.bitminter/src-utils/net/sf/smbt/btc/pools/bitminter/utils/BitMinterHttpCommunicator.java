...
public class BitMinterHttpCommunicator extends HttpCommunicator {
    protected DataInputStream in;
    
    private String portID;
    private int[] acceptedPorts;
    ...
    public BitMinterHttpCommunicator() {
		properties = new HashMap<String, String>();
	}
	public BitMinterHttpCommunicator(String pipeID, String portID, int[] acceptedPorts) {
		this();
		this.portID = portID;
