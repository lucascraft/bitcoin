...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Volume Rule</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.sf.smbt.trading.impl.VolumeRuleImpl#getVolume <em>Volume</em>}</li>
 *   <li>{@link net.sf.smbt.trading.impl.VolumeRuleImpl#getTolerance <em>Tolerance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VolumeRuleImpl extends TradingRuleImpl implements VolumeRule {
	/**
	...
	protected EClass eStaticClass() {
		return TradingPackage.Literals.VOLUME_RULE;
	}
	...
	public void setVolume(float newVolume) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TradingPackage.VOLUME_RULE__VOLUME, oldVolume, volume));
	}
	...
	public void setTolerance(float newTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TradingPackage.VOLUME_RULE__TOLERANCE, oldTolerance, tolerance));
	}
