 ...
 * @generated
 */
public class BitcoinrpcSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BitcoinrpcPackage.BITCOIN_NODE: {
				BitcoinNode bitcoinNode = (BitcoinNode)theEObject;
				T result = caseBitcoinNode(bitcoinNode);
				if (result == null) result = caseIConnectedUnit(bitcoinNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BitcoinrpcPackage.BTC_INFO: {
				BtcInfo btcInfo = (BtcInfo)theEObject;
				T result = caseBtcInfo(btcInfo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bitcoin Node</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bitcoin Node</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Btc Info</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Btc Info</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBtcInfo(BtcInfo object) {
		return null;
	}
