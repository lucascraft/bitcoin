...
public class TradingPriceRuleRatioPropertySection  extends AbstractFloatPropertySection {
	public TradingPriceRuleRatioPropertySection() {}
	...
	protected Float getFeatureFloat() {
		return new Float(((TradingRule)getEObject()).getRatio());
	}
}