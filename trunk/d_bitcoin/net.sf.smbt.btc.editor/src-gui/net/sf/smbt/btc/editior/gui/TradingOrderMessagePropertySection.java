...
public class TradingOrderMessagePropertySection extends AbstractUIStringPropertySection {
	public TradingOrderMessagePropertySection() {}
	...
	protected EStructuralFeature getFeature() {
		return TradingPackage.Literals.ORDER__MESSAGE;
	}
