...
public abstract class AbstractBigIntegerPropertySection extends
	...
	protected String getFeatureAsString() {
		return getFeatureBigInteger().toString();
	}
	 ...
	 */
	protected abstract BigInteger getFeatureBigInteger();
