...
public class TradingOrderVolumePropertySection  extends AbstractFloatPropertySection {
	public TradingOrderVolumePropertySection() {}
	...
	protected EStructuralFeature getFeature() {
		return TradingPackage.Literals.ORDER__VOLUME;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((Order)getEObject()).getVolume());
	}
}