...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.btc.mtgox.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_addr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_addr_feature", "_UI_Link_type"),
				 MtgoxPackage.Literals.LINK__ADDR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Link)object).getAddr();
