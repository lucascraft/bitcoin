 ...
 * are made available under the te	rms of the Eclipse Public License v1.0
...
public class BlockchainFrameInterpreter  extends AbstractFrameInterpreterImpl {
	@Override
	public synchronized Cmd byteArray2Cmd(final byte[] stream) {
		BlockchainCmd blockchainCmd = BlockchaincmdFactory.eINSTANCE.createBlockchainCmd();
		if (stream != null) {
			String text = new String(stream);
			blockchainCmd.setJsonRcv(text);
		}
