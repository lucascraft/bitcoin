 ...
 * @generated
 */
public class BlockchaincmdAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public BlockchaincmdAdapterFactory() {
	 ...
	 * @generated
	 */
	protected BlockchaincmdSwitch<Adapter> modelSwitch =
		new BlockchaincmdSwitch<Adapter>() {
			@Override
			public Adapter caseBlockchainCmd(BlockchainCmd object) {
				return createBlockchainCmdAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.smbt.btc.blockchaincmd.BlockchainCmd <em>Blockchain Cmd</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBlockchainCmdAdapter() {
		return null;
	}
