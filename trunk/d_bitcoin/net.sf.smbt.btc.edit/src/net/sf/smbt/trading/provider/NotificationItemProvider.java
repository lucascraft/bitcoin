...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.trading.Notification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NotificationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Notification_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Notification_target_feature", "_UI_Notification_type"),
				 TradingPackage.Literals.NOTIFICATION__TARGET,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((net.sf.smbt.trading.Notification)object).getTarget();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(net.sf.smbt.trading.Notification.class)) {
