...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.btc.Wallet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WalletItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BtcPackage.Literals.WALLET__BALANCE,
				 true,
				 false,
				 false,
	...
	protected void addCurrencyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Wallet_currency_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Wallet_currency_feature", "_UI_Wallet_type"),
				 BtcPackage.Literals.WALLET__CURRENCY,
				 true,
				 false,
				 false,
	...
	protected void addKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Wallet_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Wallet_key_feature", "_UI_Wallet_type"),
				 BtcPackage.Literals.WALLET__KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Wallet_type") + " " + wallet.getBalance();
	}
