...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.btc.Order} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrderItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BtcPackage.Literals.ORDER__PRICE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BtcPackage.Literals.ORDER__VOLUME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BtcPackage.Literals.ORDER__KIND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Order_type") + " " + order.getPrice();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Order.class)) {
			case BtcPackage.ORDER__PRICE:
			case BtcPackage.ORDER__VOLUME:
			case BtcPackage.ORDER__KIND:
