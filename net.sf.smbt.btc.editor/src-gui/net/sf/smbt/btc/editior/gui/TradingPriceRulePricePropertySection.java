...
public class TradingPriceRulePricePropertySection  extends AbstractFloatPropertySection {
	public TradingPriceRulePricePropertySection() {}
	...
	protected EStructuralFeature getFeature() {
		return TradingPackage.Literals.PRICE_RULE__PRICE;
	}
	...
	protected Float getFeatureFloat() {
		return new Float(((PriceRule)getEObject()).getPrice());
	}
}